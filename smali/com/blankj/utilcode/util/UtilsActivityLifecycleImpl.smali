...
.field public static final STUB:Landroid/app/Activity;


# instance fields
.field public final mActivityLifecycleCallbacksMap:Ljava/util/concurrent/ConcurrentHashMap;

.field public final mActivityList:Ljava/util/LinkedList;

.field public mConfigCount:I

.field public mForegroundCount:I

.field public mIsBackground:Z

.field public final mStatusListeners:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->mStatusListeners:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->mActivityLifecycleCallbacksMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static processHideSoftInputOnActivityDestroy(Landroid/app/Activity;Z)V
    .locals 2
...
# virtual methods
.method public final consumeActivityLifecycleCallbacks(Landroid/app/Activity;Landroidx/lifecycle/Lifecycle$Event;)V
    .locals 2

    iget-object v0, p0, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->mActivityLifecycleCallbacksMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->consumeLifecycle(Landroid/app/Activity;Landroidx/lifecycle/Lifecycle$Event;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->consumeLifecycle(Landroid/app/Activity;Landroidx/lifecycle/Lifecycle$Event;Ljava/util/List;)V

    return-void
.end method

.method public final consumeLifecycle(Landroid/app/Activity;Landroidx/lifecycle/Lifecycle$Event;Ljava/util/List;)V
    .locals 2
    ...
    iget-object p0, p0, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->mActivityLifecycleCallbacksMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final getActivityList()Ljava/util/LinkedList;
    .locals 8

    iget-object p0, p0, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->mActivityList:Ljava/util/LinkedList;
    ...
    :try_start_0
    invoke-static {}, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->getActivityThread()Ljava/lang/Object;
...
.method public final onActivityCreated(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->postStatus(Z)V
    ...
    iget-object p2, p2, Lcom/blankj/utilcode/util/SPUtils;->sp:Landroid/content/SharedPreferences;
    ...
    :cond_a
    :goto_7
    invoke-virtual {p0, p1}, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->setTopActivity(Landroid/app/Activity;)V

    sget-object p2, Landroidx/lifecycle/Lifecycle$Event;->ON_CREATE:Landroidx/lifecycle/Lifecycle$Event;

    invoke-virtual {p0, p1, p2}, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->consumeActivityLifecycleCallbacks(Landroid/app/Activity;Landroidx/lifecycle/Lifecycle$Event;)V
...
.method public final onActivityDestroyed(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->consumeActivityLifecycleCallbacks(Landroid/app/Activity;Landroidx/lifecycle/Lifecycle$Event;)V
...
.method public final onActivityResumed(Landroid/app/Activity;)V
    ...
    :cond_0
    invoke-static {p1, v1}, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->processHideSoftInputOnActivityDestroy(Landroid/app/Activity;Z)V
...
.method public final postStatus(Z)V
    .locals 1

    iget-object p0, p0, Lcom/blankj/utilcode/util/UtilsActivityLifecycleImpl;->mStatusListeners:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final setTopActivity(Landroid/app/Activity;)V
    .locals 1
