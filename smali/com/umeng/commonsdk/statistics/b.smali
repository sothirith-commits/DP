.class public final Lcom/umeng/commonsdk/statistics/b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/umeng/commonsdk/statistics/b;->j:Ljava/util/HashMap;
...
.method public static a(Landroid/content/Context;Lcom/umeng/commonsdk/statistics/idtracking/Envelope;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    .locals 6
    ...
    invoke-virtual {p1}, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;->toBinary()[B
    ...
    invoke-static {p0, p2, p1}, Lcom/umeng/commonsdk/framework/UMFrUtils;->saveEnvelopeFile(Landroid/content/Context;Ljava/lang/String;[B)I
    ...
    :cond_5
    sget-object p2, Lcom/umeng/commonsdk/stateless/a;->f:Ljava/lang/String;
...
.method public static a(Landroid/content/Context;[B)Lcom/umeng/commonsdk/statistics/idtracking/Envelope;
    .locals 10
    ...
    invoke-static {p0, v0, v1}, Lcom/umeng/commonsdk/framework/UMEnvelopeBuild;->imprintProperty(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, p1}, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;->genEnvelope(Landroid/content/Context;Ljava/lang/String;[B)Lcom/umeng/commonsdk/statistics/idtracking/Envelope;
    ...
    new-instance v8, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;

    const-string v9, "123456789098765432102:00:00:00:00:00"

    invoke-virtual {v9}, Ljava/lang/String;->getBytes()[B

    move-result-object v9

    invoke-direct {v8, p1, v2, v9}, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;-><init>([BLjava/lang/String;[B)V

    iput-boolean v0, v8, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;->encrypt:Z

    invoke-static {v6}, Lcom/umeng/commonsdk/statistics/common/DataHelper;->reverseHexString(Ljava/lang/String;)[B

    move-result-object p1

    iput-object p1, v8, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;->mSignature:[B

    iput v7, v8, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;->mSerialNo:I

    invoke-virtual {v8}, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;->seal()V
    ...
    iget-object v0, v8, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;->mSignature:[B
    ...
    invoke-virtual {v8, p0}, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;->export(Landroid/content/Context;)V
    :try_end_1
...
.method public static a(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Lcom/umeng/commonsdk/statistics/b;->j:Ljava/util/HashMap;
...
.method public static a(ILorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 1
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Z)Lorg/json/JSONObject;
    ...
    invoke-static/range {p0 .. p0}, Lcom/umeng/commonsdk/utils/UMUtils;->getAppVersionName(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v14}, Lcom/umeng/commonsdk/statistics/common/HelperUtils;->getUmengMD5(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/umeng/commonsdk/statistics/common/DeviceConfig;->getSubOSName()Ljava/lang/String;
    ...
    :cond_2
    invoke-static {}, Lcom/umeng/commonsdk/statistics/common/DeviceConfig;->getSubOSVersion()Ljava/lang/String;
    ...
    sget-object v5, Lcom/umeng/commonsdk/utils/UMUtils;->SP_FILE_NAME:Ljava/lang/String;
    ...
    :try_start_7
    invoke-interface {v4, v7, v11}, Landroid/content/SharedPreferences;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :catchall_1
    :try_start_8
    invoke-static/range {p0 .. p0}, Lcom/umeng/commonsdk/statistics/common/DeviceConfig;->hasRequestPermission(Landroid/content/Context;)Z

    move-result v4

    if-eqz v4, :cond_f

    const-string v4, "xpus"
    ...
    invoke-static {v4}, Lcom/umeng/commonsdk/statistics/common/DeviceConfig;->hasOpsPermission(Landroid/content/Context;)Z

    move-result v4

    if-eqz v4, :cond_f

    const-string v4, "rpus"
    ...
    invoke-interface {v8, v6, v10}, Landroid/content/SharedPreferences;->getInt(Ljava/lang/String;I)I
    ...
    invoke-static/range {p0 .. p0}, Lcom/umeng/commonsdk/utils/UMUtils;->checkPermission(Landroid/content/Context;)Z
    ...
    :cond_19
    :try_start_17
    invoke-static {}, Lcom/umeng/commonsdk/statistics/TagHelper;->getModuleTags()Ljava/util/HashMap;
    ...
    invoke-virtual {v0}, Lcom/umeng/commonsdk/statistics/idtracking/ImprintHandler;->a$1()[B
...
.method public static a(Landroid/content/Context;Lorg/json/JSONObject;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/json/JSONObject;
    .locals 8
    ...
    :goto_0
    invoke-static {p0, p4, v2}, Lcom/umeng/commonsdk/statistics/b;->a(Landroid/content/Context;Ljava/lang/String;Z)Lorg/json/JSONObject;
    ...
    invoke-static {p3, v2}, Lcom/umeng/commonsdk/statistics/b;->a(ILorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    invoke-virtual {p4, v4, p5}, Ljava/lang/String;->substring(II)Ljava/lang/String;
    ...
    invoke-virtual {p5}, Lcom/umeng/commonsdk/statistics/idtracking/e;->b()V
    ...
    :try_start_4
    iget-object v5, p5, Lcom/umeng/commonsdk/statistics/idtracking/e;->e:Lcom/umeng/commonsdk/statistics/proto/c;
    :try_end_4
    ...
    new-instance p5, Lcom/umeng/analytics/pro/bz;

    invoke-direct {p5}, Lcom/umeng/analytics/pro/bz;-><init>()V

    invoke-virtual {p5, v5}, Lcom/umeng/analytics/pro/bz;->a(Lcom/umeng/analytics/pro/bq;)[B
    ...
    invoke-static {p5}, Lcom/umeng/commonsdk/statistics/b;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p5

    invoke-virtual {v2, p5, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    ...
    invoke-static {p0, p5}, Lcom/umeng/commonsdk/statistics/b;->a(Landroid/content/Context;[B)Lcom/umeng/commonsdk/statistics/idtracking/Envelope;
    ...
    invoke-virtual {p5}, Lcom/umeng/commonsdk/statistics/idtracking/Envelope;->toBinary()[B
    ...
    :goto_6
    invoke-static {p0, p5, p4, v3, p3}, Lcom/umeng/commonsdk/statistics/b;->a(Landroid/content/Context;Lcom/umeng/commonsdk/statistics/idtracking/Envelope;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_11
    sget-object p3, Lcom/umeng/commonsdk/stateless/b;->e:Ljava/lang/Object;
    ...
    :try_start_7
    sget-object p4, Lcom/umeng/commonsdk/stateless/b;->i:Lcom/umeng/commonsdk/framework/a$a;
    ...
    :try_start_8
    new-instance p3, Lcom/umeng/commonsdk/stateless/b;

    invoke-direct {p3, p0}, Lcom/umeng/commonsdk/stateless/b;-><init>(Landroid/content/Context;)V

    const-string p3, "MobclickRT"

    const-string p4, "--->>> Envelope built successfully: Triggered consumption action for data warehouse envelope #2."

    invoke-static {p3, p4}, Lcom/umeng/commonsdk/debug/UMRTLog;->e(Ljava/lang/String;Ljava/lang/String;)V

    const/16 p3, 0x112

    invoke-static {p3}, Lcom/umeng/commonsdk/stateless/b;->b(I)V
    :try_end_8
    ...
    :goto_9
    invoke-static {p0, p3}, Lcom/umeng/commonsdk/internal/crash/UMCrashManager;->reportCrash(Landroid/content/Context;Ljava/lang/Throwable;)V
    ...
    :cond_15
    invoke-static {v0, p3}, Lcom/umeng/commonsdk/statistics/b;->a(ILorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_16
    invoke-static {v0, v1}, Lcom/umeng/commonsdk/statistics/b;->a(ILorg/json/JSONObject;)Lorg/json/JSONObject;
