...
# instance fields
.field public volatile call:Lokhttp3/internal/connection/RealCall;
...
.field public stream:Lcom/bumptech/glide/util/ContentLengthInputStream;
...
.method public final cancel()V
    ...
    iget-object p0, p0, Lcom/bumptech/glide/integration/okhttp3/OkHttpStreamFetcher;->call:Lokhttp3/internal/connection/RealCall;
...
.method public final cleanup()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/bumptech/glide/integration/okhttp3/OkHttpStreamFetcher;->stream:Lcom/bumptech/glide/util/ContentLengthInputStream;
...
.method public final loadData(Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/data/DataFetcher$DataCallback;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/Request$Builder;->url(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v2, v1}, Lokhttp3/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p2, p1, v1}, Lokhttp3/internal/connection/RealCall;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/Request;Z)V

    iput-object v0, p0, Lcom/bumptech/glide/integration/okhttp3/OkHttpStreamFetcher;->call:Lokhttp3/internal/connection/RealCall;

    iget-object p1, p0, Lcom/bumptech/glide/integration/okhttp3/OkHttpStreamFetcher;->call:Lokhttp3/internal/connection/RealCall;
...
.method public final onResponse(Lokhttp3/internal/connection/RealCall;Lokhttp3/Response;)V
    ...
    iput-object v1, p0, Lcom/bumptech/glide/integration/okhttp3/OkHttpStreamFetcher;->stream:Lcom/bumptech/glide/util/ContentLengthInputStream;

    iget-object p0, p0, Lcom/bumptech/glide/integration/okhttp3/OkHttpStreamFetcher;->callback:Lcom/bumptech/glide/load/data/DataFetcher$DataCallback;

    invoke-interface {p0, v1}, Lcom/bumptech/glide/load/data/DataFetcher$DataCallback;->onDataReady(Ljava/lang/Object;)V
    ...
    iget-object v0, p2, Lokhttp3/Response;->message:Ljava/lang/String;

    iget p2, p2, Lokhttp3/Response;->code:I

    const/4 v1, 0x0

    invoke-direct {p1, v0, p2, v1}, Lcom/bumptech/glide/load/HttpException;-><init>(Ljava/lang/String;ILjava/io/IOException;)V
