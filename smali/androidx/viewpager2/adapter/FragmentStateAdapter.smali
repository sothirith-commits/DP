...
.method private ensureFragment(I)V
    ...
    invoke-virtual {p0, p1, v0, v1}, Landroidx/collection/LongSparseArray;->put(Ljava/lang/Object;J)V
...
.method private isFragmentViewBound(J)Z
    ...
    iget-boolean v1, v0, Landroidx/collection/LongSparseArray;->mGarbage:Z

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Landroidx/collection/LongSparseArray;->gc()V

    :cond_0
    iget-object v1, v0, Landroidx/collection/LongSparseArray;->mKeys:[J

    iget v0, v0, Landroidx/collection/LongSparseArray;->mSize:I

    invoke-static {v1, v0, p1, p2}, Landroidx/collection/ContainerHelpers;->binarySearch([JIJ)I
...
.method private removeFragment(J)V
    ...
    invoke-virtual {v1, v2, p1, p2}, Landroidx/collection/LongSparseArray;->put(Ljava/lang/Object;J)V
...
.method private scheduleViewAttach(Landroidx/fragment/app/Fragment;Landroid/widget/FrameLayout;)V
    ...
    iget-object p0, v0, Landroidx/fragment/app/FragmentManager;->mLifecycleCallbacksDispatcher:Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;

    iget-object p0, p0, Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;->animation:Ljava/lang/Cloneable;

    check-cast p0, Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance p1, Landroidx/fragment/app/FragmentLifecycleCallbacksDispatcher$FragmentLifecycleCallbacksHolder;

    const/4 p2, 0x0

    invoke-direct {p1, v1, p2}, Landroidx/fragment/app/FragmentLifecycleCallbacksDispatcher$FragmentLifecycleCallbacksHolder;-><init>(Landroidx/fragment/app/FragmentManager$FragmentLifecycleCallbacks;Z)V
...
.method public final onBindViewHolder(Landroidx/viewpager2/adapter/FragmentViewHolder;I)V
    ...
    invoke-virtual {v3, v2, v0, v1}, Landroidx/collection/LongSparseArray;->put(Ljava/lang/Object;J)V
...
.method public placeFragmentInViewHolder(Landroidx/viewpager2/adapter/FragmentViewHolder;)V
    ...
    invoke-virtual {v2, v0, p1}, Landroidx/fragment/app/BackStackRecord;->setMaxLifecycle(Landroidx/fragment/app/Fragment;Landroidx/lifecycle/Lifecycle$State;)V
    ...
    invoke-virtual {p1, v2, v3}, Landroidx/fragment/app/FragmentManager;->execSingleAction(Landroidx/fragment/app/FragmentManager$OpGenerator;Z)V
    ...
    invoke-virtual {p0, v3}, Landroidx/viewpager2/adapter/FragmentStateAdapter$FragmentMaxLifecycleEnforcer;->updateFragmentMaxLifecycle(Z)V
...
.method public final restoreState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v4, v1, p1}, Landroidx/fragment/app/FragmentManager;->getFragment(Ljava/lang/String;Landroid/os/Bundle;)Landroidx/fragment/app/Fragment;

    move-result-object v1

    iget-object v4, p0, Landroidx/viewpager2/adapter/FragmentStateAdapter;->mFragments:Landroidx/collection/LongSparseArray;

    invoke-virtual {v4, v1, v2, v3}, Landroidx/collection/LongSparseArray;->put(Ljava/lang/Object;J)V
    ...
    invoke-static {p1, v1}, Landroid/sun/security/x509/AVA$$ExternalSyntheticOutline0;->m(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final saveState()Landroid/os/Parcelable;
    ...
    invoke-static {v4, v5, v6}, Landroidx/viewpager2/adapter/FragmentStateAdapter;->createKey(Ljava/lang/String;J)Ljava/lang/String;
