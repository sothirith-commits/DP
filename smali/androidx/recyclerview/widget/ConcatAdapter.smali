...
# instance fields
.field public final mController:Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public varargs constructor <init>([Landroidx/recyclerview/widget/RecyclerView$Adapter;)V
    ...
    invoke-direct {v0, p0}, Lokhttp3/internal/http2/Http2Connection$Builder;-><init>(Landroidx/recyclerview/widget/ConcatAdapter;)V

    iput-object v0, p0, Landroidx/recyclerview/widget/ConcatAdapter;->mController:Lokhttp3/internal/http2/Http2Connection$Builder;
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/ConcatAdapter;->addAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Landroidx/recyclerview/widget/ConcatAdapter;->mController:Lokhttp3/internal/http2/Http2Connection$Builder;
...
# virtual methods
.method public final addAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V
    .locals 6

    iget-object p0, p0, Landroidx/recyclerview/widget/ConcatAdapter;->mController:Lokhttp3/internal/http2/Http2Connection$Builder;
    ...
    iget v2, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->pingIntervalMillis:I
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->pushObserver:Ljava/lang/Object;

    check-cast v3, Landroidx/recyclerview/widget/StableIdStorage$NoStableIdStorage;

    invoke-virtual {v3}, Landroidx/recyclerview/widget/StableIdStorage$NoStableIdStorage;->createStableIdLookup()Lcom/bumptech/glide/GlideBuilder$1;

    move-result-object v3

    iget-object v4, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->socket:Ljava/lang/Object;

    check-cast v4, Landroidx/recyclerview/widget/ViewTypeStorage$IsolatedViewTypeStorage;

    invoke-direct {v2, p1, p0, v4, v3}, Landroidx/recyclerview/widget/NestedAdapterWrapper;-><init>(Landroidx/recyclerview/widget/RecyclerView$Adapter;Lokhttp3/internal/http2/Http2Connection$Builder;Landroidx/recyclerview/widget/ViewTypeStorage$IsolatedViewTypeStorage;Lcom/bumptech/glide/GlideBuilder$1;)V

    invoke-virtual {v0, v1, v2}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->connectionName:Ljava/io/Serializable;
    ...
    invoke-virtual {p1, v1}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->onAttachedToRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V

    goto :goto_5

    :cond_8
    iget p1, v2, Landroidx/recyclerview/widget/NestedAdapterWrapper;->mCachedItemCount:I

    if-lez p1, :cond_9

    invoke-virtual {p0, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->countItemsBefore(Landroidx/recyclerview/widget/NestedAdapterWrapper;)I

    move-result p1

    iget v0, v2, Landroidx/recyclerview/widget/NestedAdapterWrapper;->mCachedItemCount:I

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->taskRunner:Ljava/lang/Object;
...
.method public final findRelativeAdapterPositionIn(Landroidx/recyclerview/widget/RecyclerView$Adapter;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)I
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lokhttp3/internal/http2/Http2Connection$Builder;->countItemsBefore(Landroidx/recyclerview/widget/NestedAdapterWrapper;)I
    ...
    invoke-static {p3, v0, v1, v2, v3}, Landroid/sun/security/x509/AVA$$ExternalSyntheticOutline0;->m(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final getItemId(I)J
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->findWrapperAndLocalPosition(I)Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/NestedAdapterWrapper;->mStableIdLookup:Lcom/bumptech/glide/GlideBuilder$1;

    invoke-virtual {v0, v1, v2}, Lcom/bumptech/glide/GlideBuilder$1;->localToGlobal(J)J

    move-result-wide v0

    const/4 v2, 0x0

    iput-boolean v2, p1, Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;->mInUse:Z

    const/4 v2, 0x0

    iput-object v2, p1, Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;->mWrapper:Landroidx/recyclerview/widget/NestedAdapterWrapper;

    const/4 v2, -0x1

    iput v2, p1, Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;->mLocalPosition:I
...
.method public final getItemViewType(I)I
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/NestedAdapterWrapper;->mViewTypeLookup:Landroidx/emoji2/text/MetadataRepo;

    invoke-virtual {v0, v1}, Landroidx/emoji2/text/MetadataRepo;->localToGlobal(I)I

    move-result v0

    const/4 v1, 0x0

    iput-boolean v1, p1, Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;->mInUse:Z

    const/4 v1, 0x0

    iput-object v1, p1, Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;->mWrapper:Landroidx/recyclerview/widget/NestedAdapterWrapper;

    const/4 v1, -0x1

    iput v1, p1, Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;->mLocalPosition:I
...
.method public final onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {p0, p2}, Lokhttp3/internal/http2/Http2Connection$Builder;->findWrapperAndLocalPosition(I)Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;
    ...
    iput-boolean p1, p2, Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;->mInUse:Z

    const/4 p1, 0x0

    iput-object p1, p2, Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;->mWrapper:Landroidx/recyclerview/widget/NestedAdapterWrapper;

    const/4 p1, -0x1

    iput p1, p2, Landroidx/recyclerview/widget/ConcatAdapterController$WrapperAndLocalPosition;->mLocalPosition:I

    iput-object p2, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->listener:Ljava/lang/Object;
...
.method public final onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object p0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->socket:Ljava/lang/Object;

    check-cast p0, Landroidx/recyclerview/widget/ViewTypeStorage$IsolatedViewTypeStorage;

    invoke-virtual {p0, p2}, Landroidx/recyclerview/widget/ViewTypeStorage$IsolatedViewTypeStorage;->getWrapperForGlobalType(I)Landroidx/recyclerview/widget/NestedAdapterWrapper;

    move-result-object p0

    iget-object v0, p0, Landroidx/recyclerview/widget/NestedAdapterWrapper;->mViewTypeLookup:Landroidx/emoji2/text/MetadataRepo;

    invoke-virtual {v0, p2}, Landroidx/emoji2/text/MetadataRepo;->globalToLocal(I)I
...
.method public final onFailedToRecycleView(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Z
    ...
    iget-object p0, v1, Landroidx/recyclerview/widget/NestedAdapterWrapper;->adapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
...
.method public final onViewAttachedToWindow(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->getWrapper(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Landroidx/recyclerview/widget/NestedAdapterWrapper;
