...
.field public static final lengthMap:Ljava/util/HashMap;

.field public static final nameMap:Ljava/util/HashMap;

.field public static final oidMap:Ljava/util/LinkedHashMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/sun/security/ec/NamedCurve;->oidMap:Ljava/util/LinkedHashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Landroid/sun/security/ec/NamedCurve;->nameMap:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Landroid/sun/security/ec/NamedCurve;->lengthMap:Ljava/util/HashMap;
...
.method public constructor <init>(Ljava/lang/String;Landroid/sun/security/util/ObjectIdentifier;Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;I)V
    .locals 0
    ...
    invoke-virtual {p2, p1}, Landroid/sun/security/util/ObjectIdentifier;->encode(Landroid/sun/security/util/DerOutputStream;)V
...
.method public static add(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    .locals 15
    ...
    const-string v2, "Duplication oid: "

    invoke-static/range {p3 .. p3}, Landroid/sun/security/ec/NamedCurve;->bi(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    invoke-direct {v7, v8, v3}, Ljava/security/spec/ECFieldF2m;-><init>(ILjava/math/BigInteger;)V
    ...
    invoke-direct {v7, v3}, Ljava/security/spec/ECFieldFp;-><init>(Ljava/math/BigInteger;)V

    :goto_2
    new-instance v11, Ljava/security/spec/EllipticCurve;

    invoke-static/range {p4 .. p4}, Landroid/sun/security/ec/NamedCurve;->bi(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v3

    invoke-static/range {p5 .. p5}, Landroid/sun/security/ec/NamedCurve;->bi(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v6

    invoke-direct {v11, v7, v3, v6}, Ljava/security/spec/EllipticCurve;-><init>(Ljava/security/spec/ECField;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    new-instance v12, Ljava/security/spec/ECPoint;

    invoke-static/range {p6 .. p6}, Landroid/sun/security/ec/NamedCurve;->bi(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v3

    invoke-static/range {p7 .. p7}, Landroid/sun/security/ec/NamedCurve;->bi(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v6

    invoke-direct {v12, v3, v6}, Ljava/security/spec/ECPoint;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    :try_start_0
    new-instance v10, Landroid/sun/security/util/ObjectIdentifier;

    invoke-direct {v10, v0}, Landroid/sun/security/util/ObjectIdentifier;-><init>(Ljava/lang/String;)V

    new-instance v3, Landroid/sun/security/ec/NamedCurve;

    invoke-static/range {p8 .. p8}, Landroid/sun/security/ec/NamedCurve;->bi(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    invoke-direct/range {v8 .. v14}, Landroid/sun/security/ec/NamedCurve;-><init>(Ljava/lang/String;Landroid/sun/security/util/ObjectIdentifier;Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;I)V

    sget-object v6, Landroid/sun/security/ec/NamedCurve;->oidMap:Ljava/util/LinkedHashMap;
    ...
    sget-object v0, Landroid/sun/security/ec/NamedCurve;->SPLIT_PATTERN:Ljava/util/regex/Pattern;
    ...
    sget-object v9, Landroid/sun/security/ec/NamedCurve;->nameMap:Ljava/util/HashMap;
    ...
    sget-object v2, Landroid/sun/security/ec/NamedCurve;->lengthMap:Ljava/util/HashMap;
...
.method public static bi(Ljava/lang/String;)Ljava/math/BigInteger;
    .locals 2
